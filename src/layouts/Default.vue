...
<template>
  <!-- <div class="layout">
    <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-1 nav border-dashed border-4 border-gray-600">
      <div class="flex items-center flex-no-wrap text-white mr-6 ml-6">
        <g-link to="/">
          <svg
            class="fill-current h-20 w-20 mr-2"
            viewBox="0 0 571 644"
            version="1.1"
          ...
          >
            <g transform="matrix(1,0,0,1,-36.395,-10.3637)">
              ...
              <g transform="matrix(1.1877,0,0,1,-25.3399,-66.6623)">
                <circle
                  cx="343.806"
                  cy="220.685"
                  r="24.078"
              ...
              <g transform="matrix(1.1877,0,0,1,-121.309,-21.7381)">
                <circle
                  cx="343.806"
                  cy="220.685"
                  r="24.078"
      ...
      <div
        class="w-full block flex-grow lg:flex lg:items-center lg:w-auto mr-6"
        :class="isMenuOpen ? 'block' : 'hidden lg:block'"
      >
        <div class="text-3xl lg:flex-grow text-right">
          <g-link
            to="/about"
            class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white md:mr-4"
          >
            About
          </g-link>
          <g-link
    ...
    <main class="h-screen flex flex-col justify-top items-center mt-6 mr-6 ml-6">
      <slot />
    </main>
  </div> -->
  <div
